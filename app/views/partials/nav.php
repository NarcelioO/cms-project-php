...
<header class="bg-white">
  <nav class="mx-auto flex max-w-8xl border-b items-center gap-12 p-6 lg:px-8" aria-label="Global">
    <div class="flex">
    ...
    <div class="hidden lg:flex lg:gap-x-7">
      <div class="relative">
        <button type="button" class="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-700" aria-expanded="false">
          Serviços
      ...
      <a href="/sobre" class="text-sm/6 font-semibold text-gray-700">Sobre</a>
      <a href="/cursos" class="text-sm/6 font-semibold text-gray-700">Cursos</a>
      <a href="/curriculos" class="text-sm/6 font-semibold text-gray-700">Curriculos</a>
      <a href="/blog" class="text-sm/6 font-semibold text-gray-700">Blog</a>
      <a href="/parceiros" class="text-sm/6 font-semibold text-gray-700">Parceiros</a>
      <a href="/volutarios" class="text-sm/6 font-semibold text-gray-700">Voluntários</a>
      <a href="/contato" class="text-sm/6 font-semibold text-gray-700">Contato</a>
    </div>
